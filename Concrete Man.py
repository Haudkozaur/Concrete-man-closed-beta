...
def game():
    global rebar_state, playerY, playerX, playerX_change, playerY_change, kierownikchujX, kierownikchujY, kierownikchujY_change, kierownikchujX_change, bhpX_change, bhpY_change, bhpX, bhpY, rebarX, rebarY, score, hp, game_state, time, current_time, rebar_fallX, rebar_fallY, run, game_over,  hitbox_corrector
    game_state = "will see"
            ...
            for event in pygame.event.get():
                ...
                for i in range(num_of_formworks):
                    ...
                    if rebar_state == "delivered":
                        hitbox_formwork_player = hitbox(playerX, playerY, formworkX[i] +  hitbox_corrector, formworkY[i] +  hitbox_corrector)
                        hitbox_formwork_rebar = hitbox(rebarX, rebarY, formworkX[i] +  hitbox_corrector, formworkY[i] +  hitbox_corrector)
                    if rebar_state == "forsaken":
                        hitbox_formwork_player = hitbox(playerX, playerY, formworkX[i] +  hitbox_corrector, formworkY[i] +  hitbox_corrector)
                        hitbox_formwork_rebar = hitbox(rebar_fallX, rebar_fallY, formworkX[i] +  hitbox_corrector, formworkY[i] +  hitbox_corrector)
